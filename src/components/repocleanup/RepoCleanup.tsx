          ...
          <div className="mx-auto max-w-7xl">
            ...
            >
              ...
              <div className="mt-3 text-sm w-full leading-6 text-gray-500 text-center">
                ...
                <p>
                  Bluesky has creation rate limits of ~1,300 posts/likes/reposts
                  per hour and ~11,000 per day
                </p>
                <p>Deleting content counts as 1/3 of a post/like/repost</p>
                <p>
                  This tool deletes up to 4,000 records per hour and 30,000 per
                  day
                </p>
                <p>
                  You should still be able to like/post/repost normally unless
                  you're <i>very</i> active
                </p>
                <p>
                  If you start getting "Rate Limit" related errors, you can come
                  back and cancel your job
                </p>
              </div>
              {resp && (
                    ...
                    <div className="py-2 pr-6 pl-4">
                      <div className="mt-2 max-w-xl text-sm text-gray-900 text-left grid grid-cols-2">
                        ...
                        <div className="text-right">
                          ...
                          <p>
                            {new Date(job.delete_older_than).toLocaleString()}
                          </p>
          ...
          <footer className="text-center w-full mt-10">
            <div className="mx-auto max-w-7xl px-2">
              <span className="footer-text text-xs">
                This tool has deleted{" "}
                {stats?.total_num_deleted.toLocaleString()} records across{" "}
